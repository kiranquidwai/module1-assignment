...
def subscriber_thread(done_event: threading.Event) -> None:
    ...
    def on_message(c, userdata, msg):
        try:
            ...
            # Windows-compatible simulated packet loss:
            # Drop around 10% of QoS 0 messages before counting them as received.
            # QoS 1 and QoS 2 are not dropped here because they represent reliable delivery.
            if qos == 0 and seq % 10 == 0:
                return
